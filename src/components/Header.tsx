      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center gap-4">
          ...
          <nav className="flex items-center gap-2 flex-shrink-0 ml-auto">
            ...
            <Link href="/ranking" className="text-sm text-gray-600 hover:text-gray-900 px-3 py-1.5 transition-colors hidden sm:block">
              ランキング
            </Link>
            {user ? (
              user.is_anonymous ? (
                ...
                <>
                  <Link
                    href="/notifications"
                    className="relative w-7 h-7 flex items-center justify-center text-gray-500 hover:text-gray-700 transition-colors flex-shrink-0"
                    title="通知"
                  >
                    ...
                    {unreadCount > 0 && (
                      <span className="absolute -top-0.5 -right-0.5 min-w-[14px] h-3.5 flex items-center justify-center text-[9px] font-bold text-white rounded-full px-0.5" style={{ backgroundColor: '#00782F' }}>
